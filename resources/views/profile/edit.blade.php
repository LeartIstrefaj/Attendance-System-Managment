    ...
    <div class="profile">
        <div class="sm:flex sm:items-center sm:justify-between mb-6">
            ...
            <div class="flex flex-wrap items-center">
                <a href="{{ route('profile') }}" class="bg-color-3 text-gray-700 text-sm uppercase py-2 px-4 flex items-center rounded">
                    <svg class="bg-color-3 w-3 h-3 fill-current" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="long-arrow-alt-left" class="svg-inline--fa fa-long-arrow-alt-left fa-w-14" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="currentColor" d="M134.059 296H436c6.627 0 12-5.373 12-12v-56c0-6.627-5.373-12-12-12H134.059v-46.059c0-21.382-25.851-32.09-40.971-16.971L7.029 239.029c-9.373 9.373-9.373 24.569 0 33.941l86.059 86.059c15.119 15.119 40.971 4.411 40.971-16.971V296z"></path></svg>
                    <span class="bg-color-3 ml-2 text-xs font-semibold">Back to Profile</span>
                </a>
                <a href="{{ route('profile.change.password') }}" class="bg-color-3 text-gray-700 text-sm uppercase ml-2 py-2 px-4 flex items-center rounded">
                    <svg class="bg-color-3 w-3 h-3 fill-current" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="plus" class="svg-inline--fa fa-plus fa-w-14" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="currentColor" d="M416 208H272V64c0-17.67-14.33-32-32-32h-32c-17.67 0-32 14.33-32 32v144H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h144v144c0 17.67 14.33 32 32 32h32c17.67 0 32-14.33 32-32V304h144c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z"></path></svg>
                    <span class="bg-color-3 ml-2 text-xs font-semibold">Change Password</span>
                </a>
            </div>
        </div>
            ...
            <form action="{{ route('profile.update') }}" method="POST" class="w-full max-w-2xl mx-auto px-6 py-12 flex flex-wrap justify-between" enctype="multipart/form-data">
                ...
                <div class="w-full sm:w-auto order-last sm:order-first">
                    ...
                    <div class="md:flex md:items-center">
                        ...
                        <div class="md:w-2/3">
                            <button class="btn-2 w-full shadow bg-blue-500 hover:bg-blue-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="submit">
                                Update User
                            </button>
                        </div>
                    </div>
