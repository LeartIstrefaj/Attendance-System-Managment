<div class="bg-color bg-blue-700 px-4 sm:px-6 py-3 flex items-center justify-between  h-15 fixed top-0 left-0 right-0 z-50">
    <div class="flex items-center text-white">
        ...
        <span class="color font-semibold text-sm sm:text-xl tracking-tight">School Managment</span>
    </div>
    <div class="relative">
        @auth
            ...
            <div class="bg-blue-700 absolute top-0 right-0 mt-12 -mr-6 shadow rounded-bl rounded-br">
                <div class="bg-color hidden h-24 w-48" id="navdropdown">
                    <div class="bg-color px-8 py-4 border-t border-blue-800">
