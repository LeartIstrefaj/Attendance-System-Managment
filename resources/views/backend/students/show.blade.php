    ...
    <div class="roles">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex flex-wrap items-center">
                <a href="{{ route('student.index') }}" class="bg-color-3 text-gray-700 text-sm uppercase py-2 px-4 flex items-center rounded">
                    <svg class="w-3 h-3 fill-current" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="long-arrow-alt-left" class="svg-inline--fa fa-long-arrow-alt-left fa-w-14" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="currentColor" d="M134.059 296H436c6.627 0 12-5.373 12-12v-56c0-6.627-5.373-12-12-12H134.059v-46.059c0-21.382-25.851-32.09-40.971-16.971L7.029 239.029c-9.373 9.373-9.373 24.569 0 33.941l86.059 86.059c15.119 15.119 40.971 4.411 40.971-16.971V296z"></path></svg>
                    <span class="ml-2 text-xs font-semibold">Back to Student</span>
                </a>
            </div>
        </div>

        <div class="mt-8 bg-color rounded">
            <div class="w-full max-w-2xl px-6 py-12">
                ...
                <div class="w-full px-0 md:px-6 py-12 bg-color">
                    <div class="flex items-center bg-gray-200">
                        <div class="w-1/3 text-left text-gray-800 py-2 px-4 font-semibold">Code</div>
                        <div class="w-1/3 text-left text-gray-800 py-2 px-4 font-semibold">Subject</div>
                        <div class="w-1/3 text-right text-gray-800 py-2 px-4 font-semibold">Teacher</div>
                    </div>
